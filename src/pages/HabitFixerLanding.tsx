    ...
    return (
        <div className="space-y-8 relative">
            ...
            <header className="relative z-10">
                <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-accent to-red-500 mb-2 tracking-tight drop-shadow-sm">Habit Fixer</h1>
                <p className="text-text-secondary text-lg">Prove your discipline with photographic evidence.</p>
            </header>
            ...
            {loading ? (
                ...
                <div className="text-center py-24 glass-panel rounded-3xl border-dashed relative overflow-hidden group">
                    ...
                    <h3 className="text-2xl font-bold text-text-primary mb-3 relative z-10">No Fixer Protocols Active</h3>
